    ...
    <div class="uk-container">
        ...
        <div uk-filter="target: .js-filter">
            ...
            <ul class="js-filter uk-child-width-1-1 uk-grid-84-l item-64px" uk-grid uk-scrollspy="target: .anima; repeat: false; cls: animate; delay: 100">
                <?php $num = 1; while ($query->have_posts()){ $query->the_post(); ?>
                        ...
                        <div class="uk-width-auto@l">
                            <div class="width-540px uk-border-rounded uk-overflow-hidden">
                                <div class="uk-cover-container uk-background-muted my-height">
                                    ...
                                    <button id="btn-<?php echo $terms[0]->slug.$num; ?>" class="offer__btnView uk-button uk-button-default uk-position-bottom-right uk-position-small" type="button" uk-toggle="target: #toggle-usage-<?php echo $terms[0]->slug.$num; ?>; animation: uk-animation-fade; queued: true">
                                ...
                                <div id="toggle-usage-<?php echo $terms[0]->slug.$num; ?>" class="offer__contentBox uk-card uk-card-body" hidden><?php the_content(); ?></div>
                                <script>

                                    UIkit.util.on('#toggle-usage-<?php echo $terms[0]->slug.$num; ?>', 'show', function () {
                                        // do something
                                        console.log('#toggle-usage-<?php echo $terms[0]->slug.$num; ?> show');
                                        document.querySelector("#btn-<?php echo $terms[0]->slug.$num; ?>").classList.add('open');
                                    });
                                    UIkit.util.on('#toggle-usage-<?php echo $terms[0]->slug.$num; ?>', 'hide', function () {
                                        // do something
                                        console.log('#toggle-usage-<?php echo $terms[0]->slug.$num; ?> hide');
                                        document.querySelector("#btn-<?php echo $terms[0]->slug.$num; ?>").classList.remove('open');
                                    });
                                </script>
                            </div>
                        </div>
